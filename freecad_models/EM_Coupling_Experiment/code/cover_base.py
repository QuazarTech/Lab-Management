...
# Select the chamfer base part
FreeCAD.ActiveDocument.Chamfer.Base = cover_base_complete

# Select edges to be chamfered
chamfer_edges = []
chamfer_edges.append((15,  csk_chamfer, csk_chamfer))
chamfer_edges.append((16,  csk_chamfer, csk_chamfer))
chamfer_edges.append((103, csk_chamfer, csk_chamfer))
chamfer_edges.append((104, csk_chamfer, csk_chamfer))

# Chamfer the selectd edges
FreeCAD.ActiveDocument.Chamfer.Edges = chamfer_edges
del chamfer_edges

# Toggle visibility of older part to False
FreeCADGui.ActiveDocument.Cut005.Visibility = False

# Set visual properties of new part to that of old part
Gui.ActiveDocument.Chamfer.LineColor=Gui.ActiveDocument.Cut005.LineColor
Gui.ActiveDocument.Chamfer.PointColor=Gui.ActiveDocument.Cut005.PointColor
